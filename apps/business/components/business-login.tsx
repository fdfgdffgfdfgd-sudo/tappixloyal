...
export function BusinessLogin() {
  ...
  return <div className="business-login"><section><div className="login-art"><div className="portal-logo"><span>✦</span>Tappix</div><div><h1>Лояльность,<br />которая возвращает клиентов.</h1><p>CRM, бонусы, посещения и аналитика бизнеса в одном пространстве.</p></div><small>© 2026 Tappix Platform</small></div>
