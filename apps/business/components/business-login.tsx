...
export function BusinessLogin() {
  ...
  return <div className="business-login"><section><div className="login-art"><div className="portal-logo"><Image className="product-mark" src="/tappix-mark.png" alt="" aria-hidden width={32} height={32} priority/>Tappix</div><div className="login-context"><small className="login-kicker">Платформа лояльности</small><h1>Клиенты возвращаются.<br />Бизнес растёт.</h1><p>Один спокойный рабочий экран для программы, сотрудников и результатов.</p><ul><li>Запустите программу за несколько минут</li><li>Покажите клиенту понятную карту</li></ul></div><small>© 2026 Tappix Platform</small></div>
